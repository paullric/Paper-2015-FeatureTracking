...
%CMZ: This section needs to be rewritten? It doesn't agree with new figure. For example, the _ABS function should be added if we are now using ABS(rel vort) to get waves in both hemisphere. I can edit if you provide new commands.
